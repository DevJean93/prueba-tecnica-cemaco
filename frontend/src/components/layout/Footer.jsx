 ...
 const Footer = () => {
  return (
    <footer className="w-full flex flex-col font-sans">
      ...
      <div className="bg-[#f5f5f5] text-gray-800 py-10 px-6">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 text-sm">
          
  
          <div>
            <h3 className="font-bold text-base mb-4 text-black">Servicios</h3>
          ...
          <div>
            <h3 className="font-bold text-base mb-4 text-black">Nuestros valores</h3>
            <ul className="space-y-2 text-gray-700">
          ...
          <div>
            <h3 className="font-bold text-base mb-4 text-black">Venta en línea</h3>
            <ul className="space-y-2 text-gray-700">
          ...
          <div>
            <h3 className="font-bold text-base mb-4 text-black">Grupo Cemaco</h3>
            <ul className="space-y-2 text-gray-700">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-16 border-[3px] border-black flex flex-col items-center justify-center rounded-sm font-serif">
                ...
                <div>
                  ...
                  <Link to="/" className="text-xs font-bold underline mt-1 block">Conoce más</Link>
                </div>
              </div>

     
              <div className="w-24 h-24 rounded-full border-4 border-black flex flex-col items-center justify-center bg-white shadow-sm relative">
            ...
            <div className="mt-2">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                />
                <button className="bg-[#0f1f8c] hover:bg-blue-900 text-white font-bold text-xs tracking-wide uppercase px-6 py-2 rounded-full transition-colors whitespace-nowrap">
                  Suscribirme
                </button>
              </div>
            </div>
      ...
      <div className="bg-[#f5f5f5] py-4 px-6 border-t border-gray-200">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-700">
          ...
          <div className="flex gap-2">
            ...
            {['Tiktok', 'Facebook', 'Instagram', 'X', 'Youtube', 'Pinterest'].map((red) => (
              <div key={red} className="w-8 h-8 rounded-full bg-gray-500 hover:bg-cemaco-blue cursor-pointer transition-colors flex items-center justify-center text-white text-xs font-bold" title={red}>
                {red[0]} 
              </div>
            ))}
          </div>
